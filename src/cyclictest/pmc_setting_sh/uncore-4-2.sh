...
#for all counters 0:
cbo_evt_0=0x00408134		#0x00404422
cbo_evt_1=0x00408834		#0x00404822
...
#for arb-0:
wrmsr -p $rt_cpu  0x3B2 0x00400280		#0x00400180   #0x00440181 #UNC_ARB_TRK_REQUESTS.ALL

#for arb-1:
wrmsr -p $rt_cpu  0x3B3 0x00400282		#0x00400281  # no data: 0x00440184 #UNC_ARB_COH_TRK_REQUESTS.ALL
