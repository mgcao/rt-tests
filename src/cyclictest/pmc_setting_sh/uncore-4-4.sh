...
# L3_LAT_CACHE.REF
wrmsr -p $rt_cpu 0x189 0x434F2e

#OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DATA_RD
#wrmsr -p $rt_cpu 0x189 0x1430860

#OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DEMAND_DATA_RD
#wrmsr -p $rt_cpu 0x18A 0x1430160

#OFFCORE_REQUESTS_OUTSTANDING.DEMAND_DATA_RD_GE_6
#wrmsr -p $rt_cpu 0x18B 0x6430160

#OFFCORE_REQUESTS_OUTSTANDING.DEMAND_DATA_RD
#wrmsr -p $rt_cpu 0x18C 0x430160
...
#for all counters 0:
cbo_evt_0=0x00401f34		#0x00404422
cbo_evt_1=0x00408f34		#0x00404822
#cbo_evt_2=0x00404122        # no data: 0x00402134
#cbo_evt_3=0x00408122		# no data: 0x00408134
...
#for arb-0:
wrmsr -p $rt_cpu  0x3B2 0x00400181		#0x00400180   #0x00440181 #UNC_ARB_TRK_REQUESTS.ALL

#for arb-1:
wrmsr -p $rt_cpu  0x3B3 0x00400180		#0x00400281  # no data: 0x00440184 #UNC_ARB_COH_TRK_REQUESTS.ALL
...
echo -e "Latency Times Inst Cycles Tsc L2-Miss L3-Miss Stalls-L2 L3-Ref cbo-0/0 cbo-1/0 cbo-2/0 cbo-3/0 cbo-0/1 cbo-1/1 cbo-2/1 cbo-3/1  arb-0 arb-1 u-clk"
