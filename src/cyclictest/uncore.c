...
void uncore_pre_read(void)
{
    ...
    g_unc_start[4] = read_uncore_msr(MSR_UNC_ARB_PERFCTR0_0);
    g_unc_start[5] = read_uncore_msr(MSR_UNC_ARB_PERFCTR0_1);

    g_unc_start[6] = read_uncore_msr(MSR_UNC_PERF_FIXED_CTR);
...
void uncore_post_read(void)
{
    ...
    g_unc_stop[4] = read_uncore_msr(MSR_UNC_ARB_PERFCTR0_0);
    g_unc_stop[5] = read_uncore_msr(MSR_UNC_ARB_PERFCTR0_1);

    g_unc_stop[6] = read_uncore_msr(MSR_UNC_PERF_FIXED_CTR);
